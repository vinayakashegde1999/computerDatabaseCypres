...
describe('Get newly added  Comupter to databse',function(){
    it('Successfully edit the computer and retrun to main page',function(){
        ...
        cy.get('.btn.primary').click()
        cy.get(".alert-message.warning").should('include.text',`Done! Computer ${databaseName}1 has been created`)
